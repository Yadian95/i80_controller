...
#error "LV_COLOR_DEPTH应该是 16 位以匹配设置"
#endif
#if LV_COLOR_16_SWAP != 1
#error "LV_COLOR_16_SWAP应为 1 以匹配设置"
#endif
...
void ui_aboutui_screen_init(void)
{
    ...
    lv_label_set_text(ui_aboutlabel5, "IDF版本");
    ...
    lv_label_set_text(ui_aboutlabel6, "IDF5.0.0");
    ...
    lv_label_set_text(ui_aboutlabel8, "ESP32S3");
    ...
    lv_label_set_text(ui_aboutlabel12, "1.2.3");
    ...
    lv_label_set_text(ui_aboutlabel14, "8MB");
    ...
    lv_label_set_text(ui_aboutlabel18, "68-B6-B3-2D-4B-9C");
...
void ui_datetimeui_screen_init(void)
{
    ...
    lv_label_set_text(ui_date, "日期  2023年3月22日");
    ...
    lv_calendar_set_today_date(ui_calendar, 2023, 3, 22);
